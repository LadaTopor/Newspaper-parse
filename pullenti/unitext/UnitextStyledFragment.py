...
class UnitextStyledFragment:
    ...
    @staticmethod
    def _new428(_arg1 : 'UnitextStyledFragmentType', _arg2 : 'UnitextStyledFragment') -> 'UnitextStyledFragment':
        res = UnitextStyledFragment()
        res.typ = _arg1
        res.parent = _arg2
        return res
    ...
    @staticmethod
    def _new468(_arg1 : 'UnitextStyledFragment', _arg2 : 'UnitextStyledFragmentType') -> 'UnitextStyledFragment':
        res = UnitextStyledFragment()
        res.parent = _arg1
        res.typ = _arg2
        return res
    ...
    @staticmethod
    def _new480(_arg1 : 'UnitextStyledFragmentType', _arg2 : 'UnitextStyle', _arg3 : 'UnitextStyledFragment') -> 'UnitextStyledFragment':
        res = UnitextStyledFragment()
        res.typ = _arg1
        res.style = _arg2
        res.parent = _arg3
