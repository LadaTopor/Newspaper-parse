...
class ZipExtraData:
    ...
    def add_entry2(self, headerid : int, field_data : bytearray) -> None:
        ...
        wrapindex520 = RefOutArgWrapper(index)
        self.__set_short(wrapindex520, headerid)
        index = wrapindex520.value
        wrapindex519 = RefOutArgWrapper(index)
        self.__set_short(wrapindex519, add_length)
        index = wrapindex519.value
